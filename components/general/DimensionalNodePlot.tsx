...
function genColors(colorsIn: string[], numColors: number) {
...
function DimensionalNodePlot(props: DimensionalNodePlotProps) {
  ...
  let colors: string[];
  if ('catVals' in data) {
    colors = genColors([theme.graphColors.blue070, theme.graphColors.red050, theme.graphColors.green070], data.catVals.length);
  } else {
    colors = [defaultColor]
  }
